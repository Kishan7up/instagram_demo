...
public class EditImageFragment extends Fragment implements SeekBar.OnSeekBarChangeListener {
    ...
    @BindView(dhruveni.crm.instagram_demo.R.id.seekbar_brightness)
    SeekBar seekBarBrightness;

    @BindView(dhruveni.crm.instagram_demo.R.id.seekbar_contrast)
    SeekBar seekBarContrast;

    @BindView(dhruveni.crm.instagram_demo.R.id.seekbar_saturation)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(dhruveni.crm.instagram_demo.R.layout.fragment_edit_image, container, false);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean b) {
        if (listener != null) {
            ...
            if (seekBar.getId() == dhruveni.crm.instagram_demo.R.id.seekbar_brightness) {
                // brightness values are b/w -100 to +100
                listener.onBrightnessChanged(progress - 100);
            }

            if (seekBar.getId() == dhruveni.crm.instagram_demo.R.id.seekbar_contrast) {
            ...
            if (seekBar.getId() == dhruveni.crm.instagram_demo.R.id.seekbar_saturation) {
                // converting int value to float
